...
<body>
	<div class="well well-small">
		<div class="row">
			<span style="margin-left: 25px;"><b>List of product</b></span> <select
				class="pull-right">
				<option>A - Z</option>
			...
			<div class="row-fluid">
				<ul class="thumbnails">
					...
					<c:forEach var="item" items="${ productsPaginate }"
						...
						<li class="span4">
							<div class="thumbnail">
								<a href="../product-detail/${ item.id_product }" class="overlay"></a> <a
									class="zoomTool" href="../product-detail/${ item.id_product }"
									title="add to cart"><span class="icon-search"></span> QUICK
									VIEW</a> <a href="<c:url value="../product-detail/${ item.id_product }"/>">
									<img
	...
	<div class="pagination">
		<c:forEach var="item" begin="1"
			...
			<c:if test="${ (loop.index) == paginateInfo.currentPage }">
				<a href="<c:url value="/category/${ idCategory }/${ loop.index }"/>"
